...
class Args:
    def __init__(self):
        ...
        self.create_gif_bool = True
        self.save_policies = False
        ...
        self.num_minibatches = 4#8 # the number of minibatches for one updating 4
        self.update_epochs = 14#14 # 4 - oridinally -- n_updates_per_iteration
        self.max_timesteps_per_episode = 1600
        self.num_episodes_per_batch_in_one_process = 1
        #self.num_steps = 3200
        self.batch_size = 6400#12800
...
if __name__ == "__main__":
    ...
    #args.seed = args.seed + (local_rank * 10)
