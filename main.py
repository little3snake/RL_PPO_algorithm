    ...
    if local_rank == 0:
        if args.track:
            ...
            wandb.init(
                ...
                #resume=True,
                save_code=True,
                settings=wandb.Settings(code_dir="."),  # Загружает все файлы в текущей директории
            )
